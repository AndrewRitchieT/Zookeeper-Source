...
(5) 改变服务器状态。一旦确定了 Leader，每个服务器就会更新自己的状态，如果是Follower，那么就变更为 FOLLOWING，如果是 Leader，就变更为 LEADING。 准leader成为正式的leader
...
![1567561385449](images/1567561385449.png)
...
![1567562166519](images/1567562166519.png)
