...
public class QuorumPeer extends ZooKeeperThread implements QuorumStats.Provider {
    ...
    /**
     * A 'view' is a node's current opinion(称呼) of the membership of the entire
     * ensemble(全体).
     */
    // "view"是一个节点(Server)对整个系统成员的当前称呼
    // 该方法获取到的是所有Server，包含Observer
